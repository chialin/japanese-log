...
日語漢字音（音讀）跟台語都保留了中古漢語的層次，是這個學習者最省力的記憶捷徑——
**但唯一的判準是「整串唸出來像不像」**，不是「有沒有推導規律」。

| 判準 | 例 |
|------|------|
| ✅ **整串音都對得上** | 局 kiok → きょく（郵便局・薬局）、一 it → いち、日 jit → じつ、電 tian → でん、練 lian → れん |
| ✅ **同一漢字＝同一音讀** | 会 → かい（会話・教会・会社），一個字認得就整組通 |
| ❌ **只有尾音／某條規律對得上** | 十 tsap → じゅう、平 ping → へい、空 khong → くう、後 hio → ご |

❌ 那類**一律不要寫**。「-ng 收尾到日文變長音」這種說法對怎麼唸完全沒有幫助——
台語 -ng 收尾的字對到 えい／おう／よう 都有，講了還是要一個一個背，等於沒有捷徑。
唸起來不像就別提台語，改用日文內部的詞群（例：じつ ＝ 平日・休日・本日 一組）
或字形／部首／生活情境去記。
...
**每次出現片假名外來語，都要交代它從哪個語言、哪個字借來的，並點出跟原字的語感落差。**
外來語不是「英文照唸」——借進日文之後常常縮小、位移，或分裂成好幾個詞，只當英文記一定會用錯。

| 要交代的 | 例 |
|------|------|
| 來源語言＋原字 | ガラス ← 荷蘭語 glas（**不是**英語 glass） |
| 跟原字的落差 | プール ← 英語 pool，但日文幾乎只指游泳池 |
| 同源分裂成好幾個詞 | ガラス（材質）／グラス（高腳杯，英語 glass）／コップ（一般杯子，荷蘭語 kop） |

⚠️ **別預設外來語都來自英語，也別預設它是什麼時候進來的**——各語言各有各的年代與領域：

| 年代 | 來源語 | 走的路 | 例 |
|------|------|------|------|
| 16 世紀 | 葡萄牙語 | 傳教士與貿易 | パン（pão）・カステラ・タバコ・テンプラ・ビードロ |
| 江戶 | 荷蘭語 | 長崎出島的**貿易**（通詞、商人） | ガラス（glas）・ゴム（gom）・ギヤマン（diamant） |
| 江戶後期 | 荷蘭語 | **蘭学**（荷蘭文書籍的學術翻譯） | メス（mes）・ピンセット（pincet）・レンズ・アルコール |
| 明治～大正 | 德語 | 醫學（醫學典範從荷蘭轉向德國） | カルテ・アルバイト・ノイローゼ |
| 明治～大正 | 法語 | 藝術與料理 | アトリエ・クレヨン・デッサン |
| 戰後～現在 | 英語 | 幾乎所有新詞 | 絕大多數 |

⚠️ **「荷蘭語來的」跟「蘭学來的」不是同一件事**——荷蘭人 1609 年就到平戶，
蘭学是十八世紀後半才成形的學術活動。日常物品（ガラス・コップ）走貿易線，
醫學器械（メス・ピンセット）才是蘭学線。寫成「經蘭学傳入」之前先想一下這個字
是不是學術詞。

⚠️ 不確定來源就直說不確定，不要猜一個英文字硬套上去。有爭議的也要講明：
例如 コップ 有荷蘭語 kop 與葡萄牙語 copo 兩說。

⚠️ 這條跟上面的音讀／台語連結是**互補**的：漢字詞查漢字音，片假名詞查來源語言，
兩邊都是「這個字為什麼長這樣」的答案，每個新字至少要走過其中一條。
